...
describe("StringField", () => {
  ...
  describe("TextWidget", () => {
    ...
    it("should assign a default value", () => {
      ...
      expect(
        node.querySelectorAll(".rjsf-field datalist > option"),
      ).toHaveLength(0);
    });
    ...
    it("should render a string field with examples", () => {
      ...
      expect(node.querySelector(".rjsf-field input")).toHaveAttribute(
        "list",
        datalistId,
      );
    });
    ...
    it("should create and set autocomplete attribute", () => {
      ...
      expect(node.querySelector("input")).toHaveAttribute(
        "autocomplete",
        "family-name",
      );
    });
  ...
  describe("SelectWidget", () => {
    ...
    it("should render empty option with placeholder text", () => {
      ...
      expect(node.querySelectorAll(".rjsf-field option")[0]).toHaveTextContent(
        "Test",
      );
    });
  ...
  describe("DateTimeWidget", () => {
    it("should render an datetime-local field", () => {
      ...
      expect(
        node.querySelectorAll(".rjsf-field [type=datetime-local]"),
      ).toHaveLength(1);
    });
    ...
    it("should render the widget with the expected id", () => {
      ...
      expect(node.querySelector("[type=datetime-local]")).toHaveAttribute(
        "id",
        "root",
      );
    });
  ...
  describe("DateWidget", () => {
    ...
    it("should reflect the change into the dom", () => {
      ...
      expect(node.querySelector("[type=date]")).toHaveValue(
  ...
  describe("AltDateTimeWidget", () => {
    ...
    it("should render the widgets with the expected ids", () => {
      ...
      const ids = [].map.call(
        ...
        (node: HTMLSelectElement) => node.id,
      );
    ...
    it("should render the widgets with the expected options' values", () => {
      ...
      const lengths = [].map.call(
        node.querySelectorAll("select"),
        (node: HTMLSelectElement) => node.length,
      );
      ...
      const monthOptionsValues = [].map.call(
        monthOptions,
    ...
    it("should render the widgets with the expected options' labels", () => {
      ...
      const monthOptions = node.querySelectorAll("select#root_month option");
      const monthOptionsLabels = [].map.call(
        monthOptions,
        (o: HTMLOptionElement) => o.text,
      );
    ...
    describe("AltDateTimeWidget with yearsRange option", () => {
      it("should render a date field with years range from 1980-1985", () => {
        const uiSchema: UiSchema = {
          "ui:widget": "alt-datetime",
          "ui:options": { yearsRange: [1980, 1985] },
        };
        const { node } = createFormComponent({
          schema: {
            type: "string",
        ...
        const yearOptionsLabels = [].map.call(
          yearOptions,
          (o: HTMLOptionElement) => o.text,
        );
      ...
      it("should render a date field with years range from 1985-1980", () => {
        const uiSchema: UiSchema = {
          "ui:widget": "alt-datetime",
          "ui:options": { yearsRange: [1985, 1980] },
        };
        const { node } = createFormComponent({
          schema: {
            type: "string",
  ...
  describe("AltDateWidget", () => {
    ...
    it("should reflect the change into the dom, even when not all values are filled", () => {
      ...
      expect(
        getSelectedOptionValue(
          node.querySelector<HTMLSelectElement>("#root_year")!,
        ),
      ).toEqual("2012");
      expect(
        getSelectedOptionValue(
          node.querySelector<HTMLSelectElement>("#root_month")!,
        ),
      ).toEqual("10");
      expect(
        getSelectedOptionValue(
          node.querySelector<HTMLSelectElement>("#root_day")!,
        ),
      ).toEqual("day");
  ...
  describe("FileWidget", () => {
    ...
    it("should render the file widget with accept attribute", () => {
      ...
      expect(node.querySelector("[type=file]")).toHaveAttribute(
        "accept",
        ".pdf",
      );
    });
