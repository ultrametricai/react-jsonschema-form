...
describe("SchemaField", () => {
  ...
  describe("Custom SchemaField component", () => {
    ...
    it("should use the specified custom SchemaType property", () => {
      ...
      expect(
        node.querySelectorAll("#custom > .rjsf-field input[type=text]"),
      ).toHaveLength(1);
    });
  });
  ...
  describe("ui:field support", () => {
    ...
    it("should provide custom field the expected fields", () => {
      ...
      expect(registry.templates.TitleFieldTemplate).toEqual(
        defaultRegistry.templates.TitleFieldTemplate,
      );
      expect(registry.templates.DescriptionFieldTemplate).toEqual(
