...
export function createComponent(
  ...
  const rerenderFunction: RerenderType = (
    newProps: NoValFormProps,
    v: ValidatorType = validator,
  ) => {
...
export function describeRepeated(title: string, fn: CreatorFn) {
  ...
  for (const formExtraProps of formExtraPropsList) {
    const createFormComponentFn = (props: NoValFormProps) =>
...
export function expectToHaveBeenCalledWithFormData(
  mock: any,
  formData: any,
  secondValue?: string | true,
) {
  const secondParam =
