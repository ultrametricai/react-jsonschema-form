...
const uiOptions: UIOptionsType = {
  ...
  ArrayFieldItemButtonsTemplate:
    CustomTemplate as unknown as UIOptionsType["ArrayFieldItemButtonsTemplate"],
  ArrayFieldTemplate:
  ...
  FallbackFieldTemplate:
    CustomTemplate as unknown as UIOptionsType["FallbackFieldTemplate"],
  FieldErrorTemplate:
  ...
  MultiSchemaFieldTemplate:
    CustomTemplate as unknown as UIOptionsType["MultiSchemaFieldTemplate"],
  ObjectFieldTemplate:
    CustomTemplate as unknown as UIOptionsType["ObjectFieldTemplate"],
  OptionalDataControlsTemplate:
    CustomTemplate as unknown as UIOptionsType["OptionalDataControlsTemplate"],
  TitleFieldTemplate:
