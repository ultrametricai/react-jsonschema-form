(function (global, factory) {
  ...
  var shallowAllOfMerge = jsonSchemaMerge.createShallowAllOfMerge(
        ...
        return xxxOfs.find((xxx2) => {
          return isEqual2(
            get16(
              ...
              get16(xxx2, [PROPERTIES_KEY, selectorField, CONST_KEY])
            ),
            data
          );
        });
  ...
  function getDisplayLabel(validator, schema, uiSchema = {}, rootSchema, globalOptions, experimental_customMergeAllOf) {
    ...
    if (displayLabel) {
      const schemaType = getSchemaType(schema);
      const addedByAdditionalProperty = get16(
        schema,
  ...
  var ErrorSchemaBuilder = class {
    ...
    getOrCreateErrorBlock(pathOfError) {
      ...
      let errorBlock = hasPath ? (
        ...
        get16(this.errorSchema, pathOfError)
      ) : this.errorSchema;
  ...
  function getChangedFields(a, b) {
    ...
    if (aIsPlainObject && !bIsPlainObject) {
      ...
      const unequalFields = keys(
        pickBy(a, (value, key) => !deepEquals(value, get16(b, key)))
      );
