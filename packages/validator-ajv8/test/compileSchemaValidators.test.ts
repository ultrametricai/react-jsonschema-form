...
import compileSchemaValidators, {
  compileSchemaValidatorsCode,
} from "../src/compileSchemaValidators";
...
describe("compileSchemaValidators()", () => {
  ...
  describe("compiling without additional options", () => {
    beforeAll(() => {
      ...
      (compileSchemaValidatorsCode as jest.Mock).mockImplementation(
        () => expectedCode,
      );
  ...
  describe("compiling WITH additional options", () => {
    ...
    it("compileSchemaValidatorsCode was called with the expected options", () => {
      expect(compileSchemaValidatorsCode).toHaveBeenCalledWith(
        testSchema,
        customOptions,
      );
    });
